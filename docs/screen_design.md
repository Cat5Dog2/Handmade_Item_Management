...
| 13 | 再試行ボタン | ボタン | 通信失敗時 |
| 14 | まとめて印刷ボタン | ボタン | 選択モードに入り、異なる商品30件のQRコードをA4縦向き、3列×10行、1面あたり横6.5cm×縦2.5cmで印刷 |
...
### 6.3.7 操作
- 商品行タップで商品詳細へ遷移
- まとめて印刷ボタン押下で商品選択モードへ切り替え、30件選択後に選択商品のQRコードを印刷する
- 新規登録ボタン押下で商品登録画面へ遷移
...
| 19 | QR印刷ボタン | ボタン | 表示中のQRコードをA4縦向き、3列×10行の30面、1面あたり横6.5cm×縦2.5cmで印刷 |
| 20 | 編集ボタン | ボタン | 商品編集へ遷移 |
| 21 | 削除ボタン | ボタン | 商品削除確認を表示 |
| 22 | タスク管理ボタン | ボタン | タスク管理画面へ遷移 |
...
- QR印刷ボタン押下で表示中のQRコードをA4縦向き、3列×10行の30面、1面あたり横6.5cm×縦2.5cmで印刷する
- 編集ボタン押下で商品編集画面へ遷移
