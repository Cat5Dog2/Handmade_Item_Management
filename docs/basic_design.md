...
- まとめて印刷では商品一覧上で異なる商品を30件選択し、選択した商品のQRコードをA4縦向き、3列×10行、1面あたり横6.5cm×縦2.5cmで印刷する
...
- QR印刷ボタンから表示中のQRコードをA4縦向き、3列×10行の30面、1面あたり横6.5cm×縦2.5cmで印刷できる
...
- 同一商品には同一QRコードを利用する
- QR印刷は商品詳細画面で表示中の商品QRをA4縦向き、3列×10行の30面、1面あたり横6.5cm×縦2.5cmで出力する
- 商品一覧のまとめて印刷では異なる商品30件のQRを同じ30面レイアウトで出力する
