...
- まとめて印刷では商品一覧上で異なる商品を10件選択し、選択した商品のQRコードをA4縦向き、2列×5行で印刷する
...
- QR印刷ボタンから表示中のQRコードをA4縦向き、2列×5行の10面で印刷できる
...
- 同一商品には同一QRコードを利用する
- QR印刷は商品詳細画面で表示中の商品QRをA4縦向き、2列×5行の10面で出力する
- 商品一覧のまとめて印刷では異なる商品10件のQRを同じ10面レイアウトで出力する
